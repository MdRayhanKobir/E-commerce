...
@php
    ...
    $delivary=DB::table('orders')->where('status',3)->where('date',$date)->sum('total');
...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      <a class="breadcrumb-item" href="index.html">Easy-Find</a>
    ...
    <div class="sl-pagebody">
      ...
      <div class="row row-sm">
        <div class="col-sm-6 col-xl-3">
          <div class="card pd-20 rounded " style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;background-color:#82ccdd">
            <div class="d-flex justify-content-between align-items-center mg-b-10">
              <h6 class="tx-14 tx-uppercase mg-b-0 tx-spacing-1 tx-white">Today's Sales</h6>
              <a href="" class="tx-white-8 hover-white"><i class="icon ion-android-more-horizontal"></i></a>
            </div><!-- card-header -->
            <div class="d-flex align-items-center justify-content-between">
              <span class="sparkline2"><img src="{{ asset('backend/img/sales.png') }}" alt="" style="width:60px"></span>
        ...
        <div class="col-sm-6 col-xl-3">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card pd-20 rounded " style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;background-color:#82ccdd">
              <div class="d-flex justify-content-between align-items-center mg-b-10">
                <h6 class="tx-14 tx-uppercase mg-b-0 tx-spacing-1 tx-white">Today's Delivary</h6>
                <a href="" class="tx-white-8 hover-white"><i class="icon ion-android-more-horizontal"></i></a>
              </div><!-- card-header -->
              <div class="d-flex align-items-center justify-content-between">
                <span class="sparkline2"><img src="{{ asset('backend/img/sales.png') }}" alt="" style="width:60px"></span>
        ...
        <div class="col-sm-6 col-xl-3">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card pd-20 rounded " style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;background-color:#82ccdd">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <span class="sparkline2"><img src="{{ asset('backend/img/sales.png') }}" alt="" style="width:60px"></span>
                <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ count($user) }} person</h3>
              </div><!-- card-body -->
            </div><!-- card -->
          </div><!-- col-3 -->
