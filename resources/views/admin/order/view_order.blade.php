    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="row">
                ...
                @if ($order->status==0)
                <a href="{{ route('payment.accept',['id'=>$order->id]) }}" class="btn btn-info">Payment Accept </a>
                <a href="{{ route('payment.cancel',['id'=>$order->id]) }}" class="btn btn-danger">Order Cancel </a>
                @elseif($order->status==1)
                <a href="{{ route('process.delivary',['id'=>$order->id]) }}" class="btn btn-info">Process Delivary </a>
                @elseif($order->status==2)
                <a href="{{ route('delivary.done',['id'=>$order->id]) }}" class="btn btn-success">Delivared Done </a>
                @elseif($order->status==4)
                <strong class="text-center text-danger">This product are not valid</strong>
                @else
                <strong class="text-center text-success">This product are successfully delivared</strong>
                @endif
