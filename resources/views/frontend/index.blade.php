                    ...
                    <div class="deals_slider_container">
                        ...
                        <div class="owl-carousel owl-theme deals_slider">
                            ...
                            <div class="owl-item deals_item">
                                <div class="deals_image"><img src="{{ asset($hotdeal->image_one ) }}" alt=""></div>
                                <div class="deals_content">
                                    <div class="deals_info_line d-flex flex-row justify-content-start">
                                        <div class="deals_item_category"><a href="#">{{ $hotdeal->brand_name }} by</a></div>
                                        @if ($hotdeal->discount_price==null)
                                        @else
                                        <div class="deals_item_price ml-auto"><s style="color: gray !important; font-size:20px;">৳{{$hotdeal->selling_price }}</s></div>
                                        @endif
                                    </div>
                                    <div class="deals_info_line d-flex flex-row justify-content-start">
                                        <div class="deals_item_name">{{ $hotdeal->product_name }}</div>
                                        @if ($hotdeal->discount_price==null)
                                        <div class="deals_item_price ml-auto" style="color:gray !important; ">৳{{ $hotdeal->selling_price }}</div>
                                        @else
                                        @endif

                                        @if ($hotdeal->discount_price!=null)
                                        <div class="deals_item_price ml-auto">৳{{$hotdeal->discount_price}}</div>
                                        @else
                                        @endif
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset($featured->image_one) }}" alt="" style="height:120px; width:140px;">
                                        </div>
                                        <div class="product_content ">
                                            @if ($featured->discount_price==null)
                                            <div class="product_price discount">৳{{$featured->selling_price  }}</div>
                                            @else
                                            <div class="product_price discount">৳{{$featured->discount_price}}<span><s>৳{{$featured->selling_price  }}</s></span></div>
                                            @endif
                                        ...
                                        <ul class="product_marks">
                                            @if ($featured->discount_price==null)
                                            <li class="product_mark product_discount" style="background:rgb(9, 95, 224);">new</li>
                                            @else
                        ...
                        <div class="row fill_height">
                            <div class="col-lg-4 col-md-6 fill_height">
                                <div class="banner_2_content">
                                    <div class="banner_2_category" style="font-size: 20px">{{  $midslider->category_name }}</div>
                                    <div class="banner_2_title"style="font-size: 40px">{{  $midslider->product_name }}</div>
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img src="{{ asset( $midslider->image_one) }}" alt=""  style="width: 400px; height:400px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="product_panel panel active">
                                <div class="arrivals_slider slider">
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ asset($products->image_one) }}" alt="" style="height:120px; width:140px;">
                                            </div>
                                            <div class="product_content ">
                                                @if ($products->discount_price==null)
                                                <div class="product_price discount">৳{{$products->selling_price  }}</div>
                                                @else
                                                <div class="product_price discount">৳{{$products->discount_price}}<span><s>৳{{$products->selling_price  }}</s></span></div>
                                                @endif
                                                <div class="product_name"><div><a href="product.html">{{ $products->product_name }}</a></div></div>
                                                <div class="product_extras">
                                                    <div class="product_color">
                                                        {{-- <input type="radio" checked name="product_color" style="background:#b19c83">
                                                        <input type="radio" name="product_color" style="background:#000000">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="tabbed_container">
                    <div class="tabs clearfix tabs-right">
                        <div class="new_arrivals_title">Category Two</div>
                        <ul class="clearfix">
                            <li class="active"></li>
                        </ul>
                        <div class="tabs_line"><span></span></div>
...
$buyone_getone=DB::table('products')
               ->join('brands','products.brand_id','brands.id')
               ->select('products.*','brands.brand_name')
               ->where('products.status',1)->where('buyone_getone',1)->orderBy('id','desc')->limit(6)->get();
@endphp
                            ...
                            <div class="trends_item is_new">
                                ...
                                <div class="trends_content">
                                    ...
                                    <div class="trends_info clearfix">
                                        <div class="trends_name"><a href="product.html">{{ $buyone_getone->product_name }}</a></div>
                                         <div>
                                            @if ($buyone_getone->discount_price==null)
                                            <div class="product_price discount">৳{{$buyone_getone->selling_price  }}</div>
                                            @else
                                            <div class="product_price discount">৳{{$buyone_getone->discount_price}}<span><s>৳{{$buyone_getone->selling_price  }}</s></span></div>
                                            @endif
                                ...
                                <ul class="trends_marks">
                                    ...
                                    @if ($buyone_getone->discount_price==null)
                                    <li class="trends_mark trends_new" style="background:rgb(9, 95, 224);">BuyGet</li>
                                    @else
                ...
                <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                    ...
                    <div class="newsletter_content clearfix">
                        <form action="{{ route('newsletter.store') }}" class="newsletter_form" method="post">
                            @csrf
                            <input type="email" class="newsletter_input" name="newsletter"required="required" placeholder="Enter your email address">
