                        ...
                        <div class="product_panel panel">
                            <div class="featured_slider slider">
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset($trend->image_one) }}" alt="" style="height:120px; width:140px;">
                                        </div>
                                        <div class="product_content ">
                                            @if ($trend->discount_price==null)
                                            <div class="product_price discount">৳{{$trend->selling_price  }}</div>
                                            @else
                                            <div class="product_price discount">৳{{$trend->discount_price}}<span><s>৳{{$trend->selling_price  }}</s></span></div>
                                            @endif
                                        ...
                                        <ul class="product_marks">
                                            ...
                                            <li class="product_mark product_discount">
                                                @php
                                                    ...
                                                    $discount=$amount/$trend->selling_price*100;
                                                @endphp
                                                {{ intval($discount) }}%
                                            </li>
                                            @endif
                        ...
                        <div class="product_panel panel">
                            <div class="featured_slider slider">
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset($bestrated->image_one) }}" alt="" style="height:120px; width:140px;">
                                        </div>
                                        <div class="product_content ">
                                            @if ($bestrated->discount_price==null)
                                            <div class="product_price discount">৳{{$bestrated->selling_price  }}</div>
                                            @else
                                            <div class="product_price discount">৳{{$bestrated->discount_price}}<span><s>৳{{$bestrated->selling_price  }}</s></span></div>
                                            @endif
                                            <div class="product_name"><div><a href="product.html">{{ $bestrated->product_name }}</a></div></div>
                                            <div class="product_extras">
                                                <div class="product_color">
                                                    <input type="radio" checked name="product_color" style="background:#b19c83">
                                                    <input type="radio" name="product_color" style="background:#000000">
