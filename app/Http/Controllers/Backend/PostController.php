...
class PostController extends Controller
{
    ...
    public function PostCategoryStore(Request $request){
        ...
        $notification = array(
            'messege' => 'Succesfully PostCategory Insert',
            'alert-type' => 'success'
        );
    ...
    public function PostCategoryUpdate(Request$request, $id){
        ...
        $notification = array(
            'messege' => 'Succesfully PostCategory Updated',
            'alert-type' => 'success'
        );
    ...
    public function PostCategoryDelete($id){
        ...
        $data->delete();
        $notification = array(
            'messege' => 'Succesfully PostCategory Deleted',
            'alert-type' => 'error'
        );
        return redirect()->back()->with($notification);
    }
    ...
    public function BlogStore(Request $request){
        ...
        $notification = array(
            'messege' => 'Succesfully Post Insert',
            'alert-type' => 'success'
        );
    ...
    public function BlogUpdate(Request $request,$id){
        ...
        $notification = array(
            'messege' => 'Succesfully Post Updated',
            'alert-type' => 'success'
        );
        return redirect()->route('blog.view')->with($notification);
    ...
    public function BlogDelete($id){
        ...
        $notification = array(
            'messege' => 'Succesfully Post Deleted',
            'alert-type' => 'error'
        );
        return redirect()->route('blog.view')->with($notification);
